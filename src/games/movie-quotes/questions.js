const movieQuoteQuestions = [
    ...
    },
    {
        ...
        options: ["Who Framed Roger Rabbit", "Frozen", "Toy Story", "Up"],
        answer: "Who Framed Roger Rabbit"
    },
    {
        quote: "I’m not a real boy.",
        options: ["Pinocchio", "Frozen", "Toy Story", "Up"],
        answer: "Pinocchio"
    },
    {
        quote: "When you wish upon a star.",
        options: ["Pinocchio", "Frozen", "Toy Story", "Up"],
        answer: "Pinocchio"
    },
    {
    ...
    },
    {
        ...
        options: ["Alice in Wonderland", "Frozen", "Toy Story", "Up"],
    ...
    {
        quote: "I am Iron Man.",
        options: ["Iron Man", "Frozen", "Toy Story", "Up"],
        answer: "Iron Man"
    },
    {
    ...
    },
    {
        ...
        options: ["Avengers: Endgame", "Frozen", "Toy Story", "Up"],
    ...
    },
    {
        ...
        options: ["Black Panther", "Frozen", "Toy Story", "Up"],
        answer: "Black Panther"
    },
    {
        quote: "Just keep swimming.",
        options: ["Finding Dory", "Frozen", "Toy Story", "Up"],
        answer: "Finding Dory"
    },
    {
        quote: "What would Dory do?",
        options: ["Finding Dory", "Frozen", "Toy Story", "Up"],
        answer: "Finding Dory"
    },
    {
        quote: "I suffer from short-term memory loss.",
        options: ["Finding Dory", "Frozen", "Toy Story", "Up"],
        answer: "Finding Dory"
    },
    {
    ...
    {
        quote: "I am Moana of Motunui.",
        options: ["Moana", "Frozen", "Toy Story", "Up"],
        answer: "Moana"
    },
    {
    ...
    {
        quote: "See that line where the sky meets the sea? It calls me.",
        options: ["Moana", "Frozen", "Toy Story", "Up"],
        answer: "Moana"
    },
    {
    ...
    {
        quote: "I am not a princess.",
        options: ["Moana", "Frozen", "Toy Story", "Up"],
        answer: "Moana"
    },
    {
        quote: "I’m not a hero.",
        options: ["Big Hero 6", "Frozen", "Toy Story", "Up"],
        answer: "Big Hero 6"
    },
    {
        quote: "I am satisfied with my care.",
        options: ["Big Hero 6", "Frozen", "Toy Story", "Up"],
        answer: "Big Hero 6"
    },
    {
        quote: "We didn’t set out to be superheroes.",
        options: ["Big Hero 6", "Frozen", "Toy Story", "Up"],
        answer: "Big Hero 6"
    },
    {
        quote: "I am Baymax, your personal healthcare companion.",
        options: ["Big Hero 6", "Frozen", "Toy Story", "Up"],
        answer: "Big Hero 6"
    },
    {
        quote: "I am vengeance. I am the night.",
        options: ["Batman", "Frozen", "Toy Story", "Up"],
        answer: "Batman"
    },
    {
        quote: "I’m not a monster. I’m just ahead of the curve.",
    ...
    {
        quote: "I am Groot.",
        options: ["Guardians of the Galaxy", "Frozen", "Toy Story", "Up"],
        answer: "Guardians of the Galaxy"
    },
    {
        quote: "We are Groot.",
    ...
    },
    {
        ...
        options: ["Guardians of the Galaxy Vol. 2", "Frozen", "Toy Story", "Up"],
    ...
    },
    {
        ...
        options: ["Batman Begins", "Frozen", "Toy Story", "Up"],
